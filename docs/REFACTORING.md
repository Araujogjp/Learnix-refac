...
- **MVC em camadas:** `view/TelaMenu.xaml.cs` linhas do construtor e do `AplicarFiltro`
- **SOLID-DIP:** comentário XML no construtor de `TelaMenu`, em `CursoController`, `CursoService` e `CursoRepository`
